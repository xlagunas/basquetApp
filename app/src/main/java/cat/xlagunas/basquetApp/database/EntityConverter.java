...
import cat.xlagunas.basquetapp.api.model.Competicion;
import cat.xlagunas.basquetapp.api.model.TeamDetails;
...
public class EntityConverter {
    ...
    public static cat.xlagunas.basquetapp.api.model.Favorite parseFavoriteDatabase(Favorite favorite) {
        cat.xlagunas.basquetapp.api.model.Favorite fav = new cat.xlagunas.basquetapp.api.model.Favorite();
    ...
    public static List<cat.xlagunas.basquetapp.api.model.Favorite> parseFavoriteListFromDatabase(List<Favorite> favs) {
        List<cat.xlagunas.basquetapp.api.model.Favorite> favorites = new ArrayList<>(favs.size());
